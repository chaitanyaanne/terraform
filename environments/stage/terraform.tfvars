...
# S3 Buckets
s3_buckets = {
  my-bucket       = "my-bucket-stage"
  another-bucket  = "another-bucket-stage"
}

# MSK Cluster
msk_cluster_name           = "my-msk-cluster-stage"
...
# Glue Job
glue_job_name        = "my-glue-job-stage"
glue_role_arn        = "arn:aws:iam::123456789012:role/AWSGlueServiceRole"
glue_script_location = "s3://my-bucket-stage/glue/script.py"
glue_python_version  = "3"
glue_default_arguments = {
  "--input_path"  = "s3://my-bucket-stage/input/"
  "--output_path" = "s3://my-bucket-stage/output/"
}
glue_max_retries     = 3
glue_timeout         = 2880